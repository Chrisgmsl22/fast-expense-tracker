...
CREATE TABLE "Category" (
    ...
    "isSystemCategory" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "Expense" (
    ...
    "yourPercentage" DOUBLE PRECISION NOT NULL DEFAULT 1.0,
    "actualExpenditure" DOUBLE PRECISION NOT NULL,
    "isRecurring" BOOLEAN NOT NULL DEFAULT false,
    "settlementStatus" TEXT NOT NULL DEFAULT 'not_shared',
    "paidAt" TIMESTAMP(3),
...
CREATE TABLE "Settings" (
    ...
    "defaultSharePercentage" DOUBLE PRECISION NOT NULL DEFAULT 0.68,
    "emailDay" INTEGER NOT NULL DEFAULT 1,
    "recurringPromptSuppressed" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
