...
- [summaryMix.html](./summaryMix.html) — **CHORE-22 lighter dashboard summary** ("the mix"): a cost box with a Full breakdown link, a Saved pill, and a partner pill with sent/received flows. It supersedes the dashboard rail part of `summaryLayout.html`. Amounts and the partner name are invented.
