...
| 1     | Foundation (auth + capture/edit/delete + list + month filter)                                                             | 🟢 Complete (1.1–1.10)        | [phase-1-foundation.md](./phase-1-foundation.md)         |
| 2     | Confirmed Designs V1 screens (capture/list re-skin + Income + Dashboard + Category detail + Settlement)                   | 🟡 Active (2.8, 2.9 remain)   | [phase-2-screens.md](./phase-2-screens.md)               |
