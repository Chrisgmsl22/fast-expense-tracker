...
> **UI design source of truth:** every UI slice follows [`docs/designs-screens/`](../designs-screens/README.md) — **V2 (merged direction)** for all screens, **V1** for the login. Match layout, component inventory, and the color systems; build with shadcn/Base UI + Tailwind + lucide. The `implementer` and `reviewer` agents enforce this for any UI-related work.
...
**In progress:** 1.8 · **Available next:** 1.2, 1.3, 1.5, 1.7
...
| 1.2   | 1     | fan-out     | available   | 1.1              |
| 1.3   | 1     | fan-out     | available   | 1.1              |
| 1.4   | 1     | fan-out     | blocked     | 1.1, 1.8         |
| 1.5   | 1     | fan-out     | available   | 1.1              |
| 1.6   | 1     | integration | blocked     | 1.4, 1.5         |
| 1.7   | 1     | fan-out     | available   | 1.1              |
| 1.8   | 1     | foundation  | in-progress | 1.1              |
